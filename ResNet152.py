...
from keras.backend import cast, argmax, equal
...
directories = ["Original_Images", "FlipLR_Aug", "Rotate_Aug"]
# , "Shear_Aug", "HSV_Aug", "EdgeDetect_Aug"

def load_images(targetFolder):
    sourceDir = targetFolder
    print("-------------------  READING {} ------------------- ".format(targetFolder))
    origImages = []
...
#    score = K.cast(K.equal(K.argmax(Y_valid, axis=-1), K.argmax(predictions_valid, axis=-1)), K.floatx())
#
#    print("VAL_LOSS:", loss)
#    print("VAL_ACC:", score)
...
if __name__ == '__main__':
    ...
    IMG_SIZE = 224
    img_rows, img_cols = IMG_SIZE, IMG_SIZE # Resolution of inputs
    channel = 3
    batch_size = 8
    num_classes = len(categories)
    trainingFolder = "Shopee_Training_Data/HSV_Aug/"
    testingFolder = "Test_Images/"
    
    # Load data. Please implement your own load_data() module for your own dataset
    training_set = load_images(trainingFolder)
